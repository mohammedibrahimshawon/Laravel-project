...
<body>
    ...
    <div class="login">
        ...
        <p>Not registerd?<a href="RegistrationForm.php)}}">Create an account</a></p> 
       <p>Not registerd?<li><a href="{{ route('/student/get.blade.php') }}"><i class="flaticon-user" aria-hidden="true"
